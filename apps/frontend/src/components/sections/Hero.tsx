...
export default function Hero() {
  return (
    <section className="pb-5 md:pb-10">
      <div className="relative px-2  bg-[linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.7)),url('/Images/hero_image.webp')] bg-cover bg-no-repeat bg-center  bg-[#f7f7f7]  h-[600px]  flex items-center justify-center">
